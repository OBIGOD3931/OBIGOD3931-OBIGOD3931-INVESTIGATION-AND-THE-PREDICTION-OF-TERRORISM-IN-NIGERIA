...
set_image_as_page_bg('bgimage.jpg')
...
# Prediction Tab
    ...
    st.write(":white[Provide the information below and click the prdict button to make prediction]")
...
# Report Tab
    ...
    st.write(":white[Report any act of terrorism. Terrorism will spill over if you don’t speak up.]")
